...
if (Test-Path $proto) {
  ...
  if ($lines.Count -gt 1) {
    ...
    Write-Host ("GAP = " + $gap.ToString('0.0') + "s  " + $(if($gap -lt 3){'PASS - localStorage was the cause'}else{'STILL ~'+$gap.ToString('0')+'s'}))
  }
