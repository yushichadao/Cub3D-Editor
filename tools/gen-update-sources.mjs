...
import { UPDATE_SOURCES, DOC_FETCH_ORDER, buildFetchOrder } from '../shared/infra/update-sources.mjs';

const buildFn = buildFetchOrder.toString();
...
window.CUB3D_BUILD_FETCH_ORDER = ${buildFn};
`;
