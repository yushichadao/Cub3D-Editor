...
(function () {
  var ov = {
    ...
    'ar': { aboutDesc:'أداة تصميم وتحرير مشاهد ثلاثية الأبعاد تعمل في المتصفح، مدعومة بـ Three.js.', aboutAI:'تم توليد هذا التطبيق بمساعدة أدوات TRAE وCodeBuddy.', exitTitle:'تأكيد الخروج', exitMsg:'هل تريد حفظ المشهد الحالي؟ ستفقد المحتويات غير المحفوظة عند الخروج.', exitMsgCancel:'لم تختر موقع حفظ. لم يُحفظ المشهد. هل أنت متأكد من الخروج؟', exitMsgFail:'فشل الحفظ. هل أنت متأكد من الخروج؟', exitCancel:'إلغاء', exitNoSave:'الخروج دون حفظ', exitSave:'حفظ والخروج' }
  };
