...
window.__packs['ja'] = {
  ...
  aboutRepo:'GitHubリポジトリ', manualLink:'ユーザーマニュアル', aboutCopyright:'Copyright © 2026-Present Yushichadao. All Rights Reserved.', aboutAuthor:'作者', aboutAI:'本サイトは TRAE と CodeBuddy ツールの AI 支援により生成されました。', tosLink:'利用規約', disclaimerLink:'免責事項', privacyLink:'プライバシーポリシー', tosBody:'<h4>1. 条項の同意</h4><p>本「利用規約」（以下「本規約」）は、本ウェブサイト（以下「本サービス」または「当方」）の運営者と、利用者（以下「お客様」）との間の、本サービスの利用に関する法的拘束力を有する合意です。お客様が本サービスにアクセスまたは利用した時点で、本規約の全内容を読み、理解し、同意したものとみなします。同意いただけない場合は、本サービスをご利用にならないでください。</p><h4>2. 利用範囲と制限</h4><p>本サービスは Three.js ベースの純粋なフロントエンドの 3D/2D グラフィック作成・編集ツールであり、個人の学習・クリエイティブ制作・教育・非商用目的のみに提供されます。お客様は、本サービスまたはその出力を営利・再配布・商用サービスに用いること、適用法令や公序良俗に反する行為、リバースエンジニアリングや本サービスの正常な動作の妨害をしてはならないことに同意します。お客様は、アップロード・インポート・作成するコンテンツにつき適法な権利又は権限を有し、第三者の権利を侵害しないことについて単独で責任を負います。</p><h4>3. ユーザーコンテンツと知的財産</h4><p>本サービス自体の著作権・商標権その他の知的財産は作者 Yushichadao（Copyright © 2026-Present Yushichadao. All Rights Reserved.）に帰属します。お客様が作成・アップロード・インポートした素材および生成したシーンファイルの知的財産はお客様に帰属します。お客様は、当方に対し、本サービスの提供・改善のために当該コンテンツを技術的に処理（ローカル描画・キャッシュ等）するための、非独占的・世界的・無償・取消可能なライセンスを付与します。当方はお客様のコンテンツについていかなる権利も取得しません。</p><h4>4. アカウント・料金・第三者リソース</h4><p>本サービスはアカウント登録を要せず、料金も発生しない純フロントエンドアプリケーションです。GitHub 等の第三者ウェブサイトへのリンクを便宜的に掲載する場合があり、その内容・セキュリティ・プライバシー慣行について当方は責任を負いません。当該リンクは各第三者の規約に従います。</p><h4>5. 変更・中断・終了</h4><p>当方は、予告なく本サービスの全部または一部を変更・中断・終了する権利を有します。メンテナンス・アップデート・ネットワーク障害・不可抗力等による中断またはデータ消失について、当方は責任を負いません。</p><h4>6. 責任の制限</h4><p>法令で認められる最大限度において、本サービスの利用または利用不能に起因する間接的・偶発的・特別・結果的損害について、当方は一切の責任を負いません。本サービスは「現状有姿」で提供されます（免責事項参照）。</p><h4>7. 準拠法と紛争解決</h4><p>本規約は中華人民共和国の法律（法廷地法原則を除く）に準拠します。紛争はまず友好的に協議し、解決しない場合は作者の所在地を管轄する裁判所に提訴できます。</p><h4>8. お問い合わせ</h4><p>本規約に関するご質問は、GitHub リポジトリ（github.com/yushichadao/Cub3D-Editor）までお寄せください。変更は本サービス内で公示され、変更後の継続利用は承諾とみなされます。</p>', disclaimerBody:'<h4>1. 通則</h4><p>本サービスは「現状有姿」（AS IS）および「提供可能な限り」（AS AVAILABLE）で提供され、当方は、商品性・特定目的適合性・非侵害・正確性・信頼性・無中断の可用性について、いかなる明示的または黙示的な保証もいたしません。本サービスがいかなる機器でも常に誤りなく動作し、欠陥が修正されることも保証しません。</p><h4>2. 技術的説明</h4><p>本サービスは純粋なフロントエンドの Web アプリケーションであり、WebGL/Three.js を用いてお客様のブラウザ内で 3D/2D グラフィックをローカルに描画します。動作は機器・ブラウザ互換性・ネットワーク環境に依存し、描画結果は機器やブラウザにより多少異なる場合があります。</p><h4>3. 責任の制限</h4><p>法令で認められる最大限度において、本サービスの利用・誤用・利用不能、またはその出力の依存に起因する直接的・間接的・偶発的・特別・懲罰的・結果的損害（データ消失・機器損傷・利益または業務の中断を含む）について、当方および作者 Yushichadao は、かかる損害の可能性を指摘されていたとしても一切の責任を負いません。</p><h4>4. ユーザーコンテンツの責任</h4><p>お客様は、作成・アップロード・インポートした全コンテンツについて単独で全責任を負います。本サービスは専門的な設計・法律・財務・技術の助言を構成するものではなく、出力の適法性・安全性・適性はお客様ご自身で判断されます。</p><h4>5. 第三者リソース</h4><p>本サービスは GitHub 等の第三者ウェブサイトへのリンクを含む場合があり、これらは各運営者が責任を負います。当方はその内容・可用性・セキュリティ・プライバシー慣行について保証も責任も負いません。第三者との取引・相互作用のリスクはお客様が負います。</p><h4>6. AI 機能不存在の声明</h4><p>本ウェブサイトおよび本サービス自体には、運営者が提供する生成系人工知能（AI）機能やモデルは含まれません。ページおよびコードは TRAE および CodeBuddy 等の開発ツールの支援を得て作成されましたが、これらのツールは本サービスの実行時機能には関与しません。本免責事項における「本サービス」とは、本ウェブサイトが提供する編集機能のみを指します。</p><h4>7. 変更</h4><p>当方は本免責事項をいつでも変更できるものとし、改訂版は本サービス内で公示され、継続利用は改訂の承諾とみなされます。</p>', privacyBody:'<h4>1. お客様情報の取り扱い</h4><p>当方はお客様のプライバシーを高度に尊重し、厳格に保護します。本サービスは純粋なフロントエンド（クライアントサイド）アプリケーションであり、すべての 3D モデル・テキスト・画像・テクスチャ・シーンデータはお客様のブラウザ内でローカルに処理・描画・保存され、いかなるサーバーにもアップロードされることはなく、当方はお客様のいかなるコンテンツにもアクセスできません。</p><h4>2. 収集する情報</h4><p>当方は氏名・メール・位置情報などの個人情報を能動的に収集・保存・送信することはありません。本サービスはアカウント登録を要せず、サーバーサイドのデータベースも持ちません。お客様のすべての操作はご自身の端末内で行われます。</p><h4>3. ローカル保存</h4><p>利便性向上のため、本サービスはブラウザのローカル保存（localStorage 等）を利用して、言語やテーマなどの設定およびお客様がエクスポートしたシーンデータを端末に記憶する場合があります。この情報はお客様の端末にのみ留まり、ブラウザ外に出ることはありません。ブラウザデータを削除することでいつでも消去できます。</p><h4>4. 分析と追跡</h4><p>本サービスは第三者の分析・広告・行動追跡スクリプトを一切組み込まず、サイトをまたいだ追跡やプロファイリングを行いません。</p><h4>5. 第三者リンク</h4><p>本サービスは GitHub 等の第三者ウェブサイトへのリンクを掲載する場合があります。本サービスを離れて第三者リソースにアクセスする際は、そのプライバシー慣行は当該第三者に従い、本ポリシーは適用されません。</p><h4>6. 児童のプライバシー</h4><p>本サービスは 13 歳未満の児童を対象としておらず、当方が知る上で収集することはありません。</p><h4>7. お問い合わせと変更</h4><p>本ポリシーに関するご質問は GitHub リポジトリ（github.com/yushichadao/Cub3D-Editor）まで。変更は本サービス内で公示されます。</p>',
  ...
  kbdTitleSingle:'単キー操作', kbdTitleShift:'Shift 組合せ', kbdTitleSlider:'スライダー / 入力', kbdTitleFunc:'Ctrl コンボ', kbdSelLine:'ブラシ制約直線モード（描画中は筆跡を水平 / 垂直 / 45° に制約）',
  ...
  kbdThKey:'キー', kbdThSelected:'選択時', kbdThUnselected:'非選択時', kbdThShiftKey:'Shift+', kbdThSlider:'スライダー', kbdThInput:'入力', kbdThCtrl:'Ctrl+', kbdThCombo:'組み合わせ',
  kbdBasicScaleSel:'5%拡大/縮小',
  kbdSelX:'X+/−方向に移動', kbdUnselX:'視点を前/後ろに移動',
  kbdSelY:'Y+/−方向に移動', kbdUnselY:'視点を右/左に移動',
  kbdSelZ:'Z+/−方向に移動', kbdUnselZ:'視点を上/下に移動',
  kbdSelRotZ:'Z軸 CW/CCW回転', kbdUnselRotZ:'左/右に回転',
  kbdSelRotY:'Y軸 CW/CCW回転', kbdUnselRotY:'上/下に回転',
  kbdSelRotX:'X軸 CW/CCW回転',
  kbdShiftPos:'1グリッド移動', kbdShiftPosUnselView:'1グリッド移動',
  kbdShiftRot:'90°回転', kbdShiftRotUnselView:'90°回転',
