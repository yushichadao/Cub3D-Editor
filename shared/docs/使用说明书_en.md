...
1. While reading the manual, select any text:
   ...
   - 📱 **Web · touch**: long press shows a selection anchor and two draggable handles; drag them to scan-select the text. The system copy/share bar no longer appears (this also avoids interference from Chinese OEM ROMs' "super drag" and the vivo system toolbar) — instead an in-app "sticky note / highlight / copy" overlay takes over;
